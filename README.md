...
scry3 callgraph NAME --direction up|down|both --depth N [--max-syms N] [--root-limit N]
#   all query verbs accept: --substr --in S --not-in S --def-in S --limit/--max-hits N --json  (exact scry2 flag parity)
